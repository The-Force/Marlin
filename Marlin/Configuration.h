...
#define STRING_CONFIG_H_AUTHOR "(Forc3D SKR 1.3 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Force's p3steel"
 ...
 */
#define TEMP_SENSOR_0 5 //1 original
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  19.89,  19.89 }
    #define DEFAULT_Ki_LIST {   1.63,   1.63 }
    #define DEFAULT_Kd_LIST {  60.66,  60.66 }
  #else
